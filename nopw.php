...
if (getPathFromHash() && !window.location.search.includes("path=")) {
    window.location.href = window.location.pathname + "?path=" + encodeURIComponent(getPathFromHash());
}

document.addEventListener("DOMContentLoaded", function() {
    document.querySelectorAll("a.nav-path").forEach(function(a) {
